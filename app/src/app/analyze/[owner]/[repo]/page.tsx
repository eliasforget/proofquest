...
export default async function RepositoryAnalysisPage({
  ...
  try {
    ...
    return <RepositoryAnalysisExperience analysis={analysis} locale={locale} />;
  } catch (error) {
    ...
    return (
      <main className="site-shell analyze-page">
        <header className="topbar"><Brand /><div className="topbar-cluster"><div className="top-actions">{t.analyze.failedStatus}</div><LocaleSwitcher locale={locale} /></div></header>
