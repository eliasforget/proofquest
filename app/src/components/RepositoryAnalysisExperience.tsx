...
export function RepositoryAnalysisExperience({ analysis, locale, account, cloudQuestStates }: { analysis: RepositoryAnalysis; locale: Locale; account: AccountSnapshot; cloudQuestStates: CloudQuestStates }) {
  ...
  if (revealed) return <RepositoryDashboard analysis={analysis} locale={locale} account={account} cloudQuestStates={cloudQuestStates} />;
